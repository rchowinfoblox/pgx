...
github.com/rchowinfoblox/pgx/stdlib to use pgx as a database/sql compatible driver.
...
pgx uses the github.com/rchowinfoblox/pgx/pgtype library to support more types. See
